    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Python fundamentals}
          {Individual study of Python fundamentals, emphasis on geospatial data and visualization tools.}
        \resumeItem{UCSB/CRREL snow albedo research project}
          {Collaborated with snow scientists from UC Santa Barbara and
          Cold Regions Research and Engineering Laboratory (CRREL)
          on study of albedo. My contribution focused on data curation and preparation.
          This work was ultimately published in The Cryosphere 
          \href{https://doi.org/10.5194/tc-16-1765-2022}{(https://doi.org/10.5194/tc-16-1765-2022)}.
          }
      \resumeItemListEnd
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Product ideation, product-market fit}
          {Identified clinical need for product, conducted in-depth assessement
          of market including clinical and reimbursement landscape, characterized
          product specs based on lab requirements.}
        \resumeItem{Regulatory compliance}
          {Engaged regulatory consultants \& lawyers to establish regulatory
          strategy for product and register it accordingly with FDA.
          }
        \resumeItem{Fundraising}
          {Played central role in raising capital for product development
          from private and institutional investors.
          }
        \resumeItem{Electromechanical medical device development}
          {Learned CNC and manual machine shop skills to personally manufacture our
          early prototypes, all of which were deployed into cancer hospitals for evaluation.
          }
        \resumeItem{Patenting}
          {Worked with attorneys to patent our device, resulting in an
          issued US Patent (on which I am co-inventor).
          }
        \resumeItem{Clinical evaluation}
          {Lead clinical evaluation of our product at Cedars-Sinai Medical Center in
          Los Angeles, CA, as participant in the Cedars-Sinai Accelerator,
          a selective incubator program for medical technology start-ups.
          }
      \resumeItemListEnd

    \resumeSubheading
      {}{}
      {  *Earlier experiences on LinkedIn}{}
  \resumeSubHeadingListEnd
